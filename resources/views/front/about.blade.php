		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-8">
					...
					<div class="row loaders_container">
						<div class="col-md-3 loader_col">
							<!-- Loader -->
							<div class="loader" data-perc="0.75"><span>Hard Work</span>
								<svg viewBox="0 0 100 100" style="display: block; width: 100%;"><path d="M 50,50 m 0,-48.5 a 48.5,48.5 0 1 1 0,97 a 48.5,48.5 0 1 1 0,-97" stroke="transparent" stroke-width="3" fill-opacity="0"></path><path d="M 50,50 m 0,-48.5 a 48.5,48.5 0 1 1 0,97 a 48.5,48.5 0 1 1 0,-97" stroke="rgb(32,211,74)" stroke-width="3" fill-opacity="0" style="stroke-dasharray: 304.844, 304.844; stroke-dashoffset: 76.2111;"></path></svg>
								<div class="progressbar-text" style="position: absolute; left: 50%; top: 50%; padding: 0px; margin: 0px; transform: translate(-50%, -50%); color: rgb(35, 35, 35); font-family: Roboto, sans-serif; font-size: 30px; font-weight: 500;">75%</div>
							</div>
						</div>
						<div class="col-md-3 loader_col">
							<!-- Loader -->
							<div class="loader" data-perc="0.95"><span>Passion</span>
								<svg viewBox="0 0 100 100" style="display: block; width: 100%;"><path d="M 50,50 m 0,-48.5 a 48.5,48.5 0 1 1 0,97 a 48.5,48.5 0 1 1 0,-97" stroke="transparent" stroke-width="3" fill-opacity="0"></path><path d="M 50,50 m 0,-48.5 a 48.5,48.5 0 1 1 0,97 a 48.5,48.5 0 1 1 0,-97" stroke="rgb(32,211,74)" stroke-width="3" fill-opacity="0" style="stroke-dasharray: 304.844, 304.844; stroke-dashoffset: 15.2422;"></path></svg>
								<div class="progressbar-text" style="position: absolute; left: 50%; top: 50%; padding: 0px; margin: 0px; transform: translate(-50%, -50%); color: rgb(35, 35, 35); font-family: Roboto, sans-serif; font-size: 30px; font-weight: 500;">95%</div>
							</div>
						</div>
						<div class="col-md-3 loader_col">
							<!-- Loader -->
				...
				<div class="col-lg-4 boxes_col">
					...
					<!-- Box -->
					<div class="box working_hours" style="width: 93%; margin-top: -310px;margin-left : -75px;">
					...
					<!-- Box -->
					<div class="box box_appointments" style="margin-top: 350px;margin-left : 0px;">
						...
						<div class="col-lg-3 team_col">
							<div class="team_member">
								...
								<div class="team_member_info">
									...
									<div class="team_member_title">{{$doctor->departments->dep_name}}</div>
								</div>
							</div>
						</div>
					@endforeach
